...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Nov-2020 às 15:59
...
--
-- Estrutura da tabela `autore_livros`
--

CREATE TABLE `autore_livros` (
...
(1, 'Memórias ', NULL, NULL, NULL, NULL),
...
(1, 'sistema de informação de apoio a gestão', 'Portugês', NULL, NULL, '9728589433', NULL, NULL, 7, 1, NULL, NULL, NULL, NULL),
...
--
-- Índices para tabela `autore_livros`
--
ALTER TABLE `autore_livros`
...
--
-- AUTO_INCREMENT de tabela `autore_livros`
--
ALTER TABLE `autore_livros`
